      ...
      <section className="grow flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-12 pb-20 sm:pt-20 sm:pb-32">
        <div className="max-w-4xl w-full space-y-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-150">
            <Link to="/register" className="w-full sm:w-auto px-8 py-4 bg-red-600 hover:bg-red-700 text-white rounded-xl font-bold text-lg transition-all shadow-lg shadow-red-600/20 hover:shadow-red-600/30 hover:-translate-y-0.5 uppercase tracking-wide">
              ¡Vamos con todo!
            </Link>
