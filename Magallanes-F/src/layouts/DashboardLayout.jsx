        ...
        <header className="h-20 bg-white border-b border-slate-200 hidden md:flex items-center justify-between px-8 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative group">
              ...
              {/* Tooltip */}
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2.5 py-1 bg-slate-800 text-white text-xs rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity">
            ...
            <div className="relative group">
              ...
              {/* Tooltip */}
              {!showNotifications && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2.5 py-1 bg-slate-800 text-white text-xs rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50">
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 border-4 border-transparent border-b-slate-800"></div>
                  Notificaciones
                </div>
              )}
